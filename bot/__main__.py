...
from bot import bot, app, dispatcher, updater, botStartTime, IGNORE_PENDING_REQUESTS, IS_VPS, PORT, alive, web, OWNER_ID, AUTHORIZED_CHATS, telegraph_token, DOMETG #Remove DOMETG
...
def start(update, context):
    ...
    buttons.buildbutton("Repo", "https://github.com/Deathstroke751/thunderslambot/")
    buttons.buildbutton("Site", "https://thethunderdome.tk/")
...
def main():
    ...
    if os.path.isfile(".restartmsg"):
        ...
        try:
            ...
            if DOMETG is not None:
                bot.sendMessage(chat_id=DOMETG, text=text, parse_mode=ParseMode.HTML)                
